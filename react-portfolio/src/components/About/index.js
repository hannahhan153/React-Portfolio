...
function About() {
    return (
        <section>
            <h1 id="about">Hello, my name is Hannah Han. I had the opportunity to be in the Columbia University's Boot Camp for Full Stack Web Development. I learned many skills and languages. Through this program, I learned I am mostly interested in back-end development, and I am self-motivated and optimistic about finding a solution to a bug or issue I find. 
